//Multiplicador 5bits x 5 bits

//    C:\Users\LUISED~1\AppData\Local\Temp\arduino_build_922863
...
// Configuración variables internas globales, valores presentes, futuros (salidas) y las entradas
  bool Lg0 = 0, Lg1 = 0, Lg2 = 0, VF = 0, P0 = 0, P1 = 0, R0, R1, R2, R3, R4, T0, T1, T2, T3, T4;
  bool CP = 0, GO = 0, CC = 0, Ini = 0, UNI = 0, DCN = 0, CEN = 0, UNIt = 0, DCNt = 0, CENt = 0;
  ...
  bool N2 = 1, N1 = 0, N0 = 0, Z;  //inicializadas en 4, es decir 1 0 0 binario
  bool MUX = 0, NE = 0;   
...
{  
  ...
  //señales de control en función de los bits de estado O2, O1, O0
  LV = !O2&!O1&O0;
  LSC = O2&!O1&O0;
  LDQ = !O2&O1&!O0;
  SnD = !O2&O1&O0;
